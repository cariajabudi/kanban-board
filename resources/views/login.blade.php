...
@section('content')
    ...
    <div class="md:max-w-md mx-auto mt-10">
        ...
        <form action="{{ url('user/login') }} "method="POST"
            class=" relative w-full px-8 py-5 border border-1 shadow-md rounded-xl">
            @csrf
            <h3 class="font-bold text-2xl text-center mb-10">Form Login</h3>
            <div class="relative z-0 w-full mb-6 group">
                <input type="text" name="nik" id="nik"
                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    placeholder=" " autocomplete="off" value="{{ old('nik') }}" autofocus />
                <label for="nik"
